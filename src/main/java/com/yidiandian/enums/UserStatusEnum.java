...
public enum UserStatusEnum {
    ...
    //根据code 找到desc 描述
    private static final Map<Integer, UserStatusEnum> valueLookup = new ConcurrentHashMap<>(values().length);
    static {
        for (UserStatusEnum type: EnumSet.allOf( UserStatusEnum.class)){
    ...
    public static List<Map> typeEnumList() {
        ...
        for (UserStatusEnum enumClass : UserStatusEnum.values()) {
    ...
    public static UserStatusEnum fromValue(Integer code) {
        UserStatusEnum data = valueLookup.get(code);
        if (data == null) {
